        ...
        <section id={name} className={styles.articlesInfo}>
            ...
            <section className={styles.articles}>
                ...
                <div className={styles.smallArticles}>
                    <SmallArticle title={"ARTICLE TITLE ( THE 2ND LINE) "} description={"Why do skinny jeans get so much hate? Watch any TikTok or IG Reel asking London’s Gen Z about their least favourite fashion trend and the answer is almost always some variation of ‘skiNNy JeAnS’."} image={`${BASE_URL}/${MOCK_IMAGES_ARTICLES[0]}`} />
                    <SmallArticle title={"ARTICLE TITLE ( THE 2ND LINE) "} description={"Why do skinny jeans get so much hate? Watch any TikTok or IG Reel asking London’s Gen Z about their least favourite fashion trend and the answer is almost always some variation of ‘skiNNy JeAnS’."} image={`${BASE_URL}/${MOCK_IMAGES_ARTICLES[1]}`} />
                </div>
